...
if (!isset($_SESSION['usuario']) || $_SESSION['idPuesto'] != 2) {
...
<head>
    ...
    <title>Gestión de Limpieza - Cine</title>
...
<body class="bg-light">
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <h2 class="text-center w-100">Gestión de Limpieza de Cine</h2>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalLimpiezaLabel">Bitácora de Limpieza e Inventario</h5>
